...
- [Heads](https://www.trmm.net/Heads) firmware for devices with QubesOS
...
- OpenXT [repo](https://github.com/openxt/uxen)
...
- [Redfield](https://gitlab.com/redfield/documentation/wikis/home) desktop client, *USA*
...
| --- | --- | --- | --- | --- |
| 2018 | Parallels | [Corel](https://www.parallels.com) | *Canada, Russia, USA* | Type-2 virtualization |
| [2018](https://blogs.blackberry.com/2018/11/icymi-blackberry-to-acquire-cylance) | Cylance | [Blackberry](https://www.cylance.com)| *Canada, USA* | Endpoint app ML/AI profiling |
| 2018 | Core OS | RedHat, IBM | *USA* | Enterprise container mgmt |
| 2018 | [Skyport Systems](https://web.archive.org/web/20170220010033/https://www.skyportsystems.net/) | Cisco | *USA* | Hybrid cloud remote attestation |
| 2017 | Simplivity | HPE | *USA* | Hyper-converged infrastructure |
| 2016 | [Ravello](https://web.archive.org/web/20160204035011/https://ravellosystems.com/)| [Oracle](https://cloud.oracle.com/en_US/ravello) | *Israel, USA* | Nested virt for cloud migration |
| 2016 | Annapurna Labs | [Amazon](http://www.annapurnalabs.com/about.html) | *Israel, USA* | Datacenter silicon |
| 2015 | Moka5 | &mdash; | *USA* | Type-2 endpoint mgmt |
| 2014 | PrivateCore | Facebook | *USA* | Memory encryption, SGX |
| [2012](https://www.brianmadden.com/opinion/Whats-the-story-with-Open-Kernel-Labs-and-their-dual-persona-virtualized-phone-solution) | [OK Labs](https://web.archive.org/web/20120904053512/http://www.ok-labs.com/products/okl4-microvisor) | [General Dynamics](https://gdmissionsystems.com/products/secure-mobile/hypervisor) | *Australia, USA* | Microkernel hypervisor |
| [2012](https://www.theregister.co.uk/2012/07/17/cisco_buys_virtuata/) | Virtuata | Cisco | *USA* | VM introspection |
...
| [2010](https://washingtontechnology.com/articles/2010/11/05/raytheon-cyber-solutions-provider.aspx) | [Trusted Computer Solutions](https://web.archive.org/web/20100704193925/http://www.trustedcs.com/) | [Raytheon](https://www.forcepoint.com/product/cross-domain-security/forcepoint-trusted-thin-client) | *USA* | Cross-domain thin clients |
| [2010](https://www.brianmadden.com/opinion/Intel-buys-client-hypervisor-maker-Neocleus-for-next-to-nothing) | Neocleus | Intel | *Israel, USA* | Endpoint OSS virtualization |
...
| 2007 | [XenSource](https://web.archive.org/web/20070629010223/http://xensource.com/) | [Citrix](https://www.citrix.com/products/citrix-hypervisor/) | *USA* | Type-1 OSS virtualization (Xen) |
{:.table-small}
